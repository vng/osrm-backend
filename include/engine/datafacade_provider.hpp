...
class WatchingProvider : public DataFacadeProvider<AlgorithmT, FacadeT>
{
  ...
  public:
    ...
    std::shared_ptr<const Facade> Get() const override final
    {
...
class WatchingProvider<AlgorithmT, datafacade::ContiguousInternalMemoryDataFacade> final
    : public DataFacadeProvider<AlgorithmT, datafacade::ContiguousInternalMemoryDataFacade>
{
    using Facade =
        typename DataFacadeProvider<AlgorithmT,
                                    datafacade::ContiguousInternalMemoryDataFacade>::Facade;
    DataWatchdog<AlgorithmT> watchdog;
